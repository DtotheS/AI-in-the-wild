...
all_simdf[(all_simdf['rating_same'] == 1) & (all_simdf['website'] == "Snopes")]['days_delta'].mean()
all_simdf[(all_simdf['rating_same'] == 0) & (all_simdf['website'] == "Snopes")]['days_delta'].mean()

all_simdf.to_csv("/Users/agathos/DtotheS/AI-in-the-wild/data/sn_pf_sim_result_v3.csv", index=False)
